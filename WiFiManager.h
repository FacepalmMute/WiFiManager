...
class WiFiManager
{
  ...
  private:
    ...
    std::unique_ptr<ESP8266HTTPUpdateServer> ota;
    ...
    const char*   _ota_user              = "admin";
    const char*   _ota_pass              = "admin";
